module ApplicationHelper
	...
	def make_link(text, location, image)
		...
		if (text.capitalize == controller.controller_name.capitalize) && (controller.action_name.capitalize == "Index")
			return raw("<li class='menu selected'>" + link_to(raw(text + '<br />' + image_tag(image)), location, :class => "selected") + "</li>")

		elsif (text.capitalize == controller.action_name.capitalize) 
			return raw("<li class='menu selected'>" + link_to(raw(text + '<br />' + image_tag(image)), location, :class => "selected") + "</li>")
